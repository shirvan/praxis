// MetricAlarm provider adapter.
//
// This file implements the provider.Adapter interface for Amazon CloudWatch (Metric Alarm)
...
// by the MetricAlarm Restate Virtual Object driver.
//
...
// MetricAlarmAdapter implements provider.Adapter for MetricAlarm (Amazon CloudWatch (Metric Alarm)) resources.
...
// NewMetricAlarmAdapterWithAuth creates a production MetricAlarm adapter using
...
// NewMetricAlarmAdapterWithAPI creates a MetricAlarm adapter with a pre-built API
...
// Kind returns the resource kind string "MetricAlarm" that maps template
// resource documents to this adapter in the provider registry.
func (a *MetricAlarmAdapter) Kind() string { return metricalarm.ServiceName }

// ServiceName returns the Restate Virtual Object service name for the
// MetricAlarm driver. The orchestrator uses this to dispatch durable RPCs.
func (a *MetricAlarmAdapter) ServiceName() string { return metricalarm.ServiceName }

// Scope returns the key-scope strategy for MetricAlarm resources,
// which controls how BuildKey assembles the canonical object key.
func (a *MetricAlarmAdapter) Scope() KeyScope { return KeyScopeRegion }

// BuildKey derives the canonical Restate object key for a MetricAlarm resource
// from the raw JSON resource document. The key is composed of region + alarm name,
...
// returns it as the concrete MetricAlarm spec struct expected by the driver.
...
// Provision sends a durable Provision request to the MetricAlarm Restate
...
// Delete sends a durable Delete request to the MetricAlarm Restate Virtual
...
// NormalizeOutputs converts the typed MetricAlarm driver output struct into
...
// Plan compares the desired MetricAlarm spec against the current provider
...
// an existing MetricAlarm resource by its region and provider-native ID.
...
// Import adopts an existing MetricAlarm resource into Praxis management.
...
// the typed MetricAlarm spec struct, validates required fields, and applies
