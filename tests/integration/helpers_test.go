...
// and a running LocalStack instance with S3 support.
//
...
// directly inspecting state in LocalStack.
...
// localstackAWSConfig returns an AWS config pointing at LocalStack
// with dummy credentials (LocalStack accepts any credentials).
